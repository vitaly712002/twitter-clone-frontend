...
export enum TweetsActionsType {
  ...
  REMOVE_TWEET = 'tweets/FETCH_ADD_TWEET',
  FETCH_ADD_TWEET = 'tweets/REMOVE_TWEET',
...
export interface RemoveTweetActionTypeInterface extends Action<TweetsActionsType> {
